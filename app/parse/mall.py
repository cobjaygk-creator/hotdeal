...
_MALL_HOSTS: tuple[tuple[str, str, str], ...] = (
    ...
    ("enuri.com", "에누리", "enuri"),
    ("agoda.com", "아고다", "agoda"),
    ("expedia.co.kr", "익스피디아", "expedia"),
    ("expedia.com", "익스피디아", "expedia"),
    ("yeogi.com", "여기어때", "yeogi"),
    ("yanolja.com", "야놀자", "yanolja"),
    ("trip.com", "트립닷컴", "tripcom"),
    ("tour.interpark.com", "인터파크투어", "interparktour"),
    ("hanatour.com", "하나투어", "hanatour"),
    ("modetour.com", "모두투어", "modetour"),
    ("skyscanner.co.kr", "스카이스캐너", "skyscanner"),
    ("skyscanner.net", "스카이스캐너", "skyscanner"),
    ("klook.com", "클룩", "klook"),
    ("myrealtrip.com", "마이리얼트립", "myrealtrip"),
    ("triple.guide", "트리플", "triple"),
    ("booking.com", "부킹닷컴", "booking"),
    ("airbnb.co.kr", "에어비앤비", "airbnb"),
    ("airbnb.com", "에어비앤비", "airbnb"),
)
